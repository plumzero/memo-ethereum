...
- 3.交易对(Trading Pair): 两币交易组合，示价比例。
...
- 11.流动性池(Liquidity Pool): DEX资金池，存币赚手续费。
- 12.做市商(Market Maker): 供买卖单增流动性，赚差价。
- 13.跨链(Cross-Chain): 不同区块链资产转移。
- 14.跨链桥(Cross-Chain Bridge): 跨链工具，有黑客风险。
- 15.提币(Withdrawal): 交易所转币到钱包，填对地址。
- 16.充币(Deposit): 钱包转币到交易所，等确认。
- 17.水龙头(Faucet): 免费发少量币，供体验。
- 18.OTC交易(Over-The-Counter): 点对点交易，适合大额。
- 19.合约交易(Contract Trading): 赌币价涨跌，可加杠杆。
- 20.杠杆交易(Leveraged Trading): 借资交易，盈亏放大。
...
- 24.私募(Private Placement): 项目早期向特定人发币，价低。
- 25.ICO(Initial Coin Offering): 项目首次发币募资，合规差。

安全存储类
- 1.加密货币钱包(Crypto Wallet): 存币工具，管私钥/收发币。
...
- 7.助记词(Mnemonic Phrase): 12/24词，恢复钱包，妥存。
- 8.Keystore文件: 加密恢复文件，需配置密码。
...
- 8.闪电贷(Flash Loan): 无抵押贷款，同一交易还清。
- 9.MEV(矿工可提取价值): 矿工调交易顺序赚差价
- 10.白皮书(Whitepapper): 项目文档，含技术/规划。
